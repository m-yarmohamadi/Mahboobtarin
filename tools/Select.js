  ...
  return (
    <div className="w-full py-1 flex flex-col justify-start justify-items-start items-start">
      ...
      <div className="w-full ">
        <select
          className="w-full appearance-none bg-transparent text-slate-700 border  border-primary-01 border-opacity-15 focus:border-opacity-100 rounded-md py-2 px-4   focus:outline-none focus:bg-white"
          id={name}
          name={name}
          value={value}
          onChange={onChange}
