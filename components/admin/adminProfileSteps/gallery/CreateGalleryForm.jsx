                    ...
                    formik.values.src ?
                        formik.values.src.type.split("/")[0] === "image" ?
                            <div className="aspect-video rounded-lg relative">
                                ...
                                <label htmlFor="src-gallery" className="btn btn--secondary cursor-pointer !p-2 absolute top-4 right-4">
                            ...
                            <div className="aspect-video rounded-lg relative overflow-hidden">
                                <video controls className="w-full h-full object-cover">
                                    <source src={URL.createObjectURL(formik.values.src)} type="video/mp4" />
                                </video>
                        ...
                        :
                        <>
                            <label htmlFor="src-gallery" className="text-primary-01 cursor-pointer text-xs font-semibold w-full flex flex-col justify-center items-center gap-2 py-7 border border-dashed border-slate-300 rounded-lg">
