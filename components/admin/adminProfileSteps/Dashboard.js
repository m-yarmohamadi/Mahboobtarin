    ...
    <div className="space-y-6">
      <div className="flex items-start p-6 gap-2 bg-orange-300/40 rounded-lg">
        ...
        <div className="text-sm lg:text-base text-orange-500 leading-6">
          ...
          &nbsp; سطح کاربری شما نقره ای میباشد. شما می توانید با تکمیل اطلاعات
          خود و سایر موارد درخواستی ضمن مساعدت به ارتقای بخش دانشنامه و سطح
          کاربری تان از امکانات و خدمات بیشتر سامانه برخوردار شوید.
        </div>
      </div>
