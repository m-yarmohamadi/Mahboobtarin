export default function OrderItemStatus({ status = 4, isExpert = false }) {
    ...
    const statusType = {
        0: { className: "bg-secondary-03 text-[#fff]", label: "در انتظار تایید عرضه کننده" },
        ...
        3: { className: "bg-green-600/30 text-green-600", label: !isExpert ? "تایید اولیه" : "تایید اولیه توسط شما" },
