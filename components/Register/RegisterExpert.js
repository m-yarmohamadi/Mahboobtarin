  ...
  passport_number: Yup.string().when("nationality", {
    ...
    then: (schema) =>
      schema
        ...
        .matches(/^[0-9]{8}$/, "لطفاً شماره پاسپورت معتبر 8 رقمی وارد کنید"),
    otherwise: (schema) => schema,
  }),
...
const validationSchemaStep2 = Yup.object({
  country: Yup.string()
    .required("وارد کردن کشور محل سکونت اجباری است")
    .min(3, "حداقل 3 حرف وارد کنید")
    .max(20, "حداکثر 20 حرف وارد کنید"),
...
const RegisterExpert = ({
  ...
  const submitHandlerStep2 = (values) => {
    ...
    formData.append(
      "national_code",
      nationalCode || formikStep1.values.national_code
    );
      ...
      <div className="w-full flex flex-col gap-7">
        ...
        <div className="w-full max-w-screen-lg mx-auto bg-white rounded-lg shadow-sm dark:shadow-darkSm p-6">
          ...
          <div className="">
            ...
            <div className="">
              {step === 1 && (
                <Step01 formik={formikStep1}>
                  <NextPrev prevStep={prevStep} loading={isPending} step={1} />
                </Step01>
              )}
              {step === 2 && (
                <Step02 formik={formikStep2} error={errorStep2}>
              ...
              {step === 5 && (
                <Step05 formik={formikStep5} error={errorStep5}>
