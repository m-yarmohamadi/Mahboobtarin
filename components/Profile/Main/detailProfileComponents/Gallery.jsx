	...
	if (gallery && gallery.length) {
		return (
			<div id="gallery" className="pb-16 scroll-mt-[130px] md:scroll-mt-20">
				...
				>
					<AllGallery gallery={gallery.slice(0, showMore ? gallery.length : 5)} onOpenPopup={(e) => selectMediaHandler(e)} />
					<Pictures gallery={gallery.slice(0, showMore ? gallery.length : 5)} onOpenPopup={(e) => selectMediaHandler(e)} />
					<Videos gallery={gallery.slice(0, showMore ? gallery.length : 5)} onOpenPopup={(e) => selectMediaHandler(e)} />
					<Voices gallery={gallery.slice(0, showMore ? gallery.length : 5)} onOpenPopup={(e) => selectMediaHandler(e)} />
				</TabGroup>
