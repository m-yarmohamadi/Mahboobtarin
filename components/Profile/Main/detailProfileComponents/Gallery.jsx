    ...
    if (gallery && gallery.length) {
        return (
            <div id="gallery" className="pt-16">
                ...
                <TabGroup tabs={[{ label: "همه" }, { label: "عکس" }, { label: "فیلم" }, { label: "صوت" }]}>
...
function PopupGallery({ onClose, open, gallery }) {
    ...
    return (
        <>
            <div onClick={onClose} className="w-full h-full fixed top-0 right-0 bg-slate-900 opacity-60 z-50"></div>
            <div className="w-full flex flex-col gap-6 max-w-[650px] bg-white shadow-lg dark:shadow-darkLg rounded-xl p-6 fixed top-1/2 -translate-y-1/2 right-1/2 translate-x-1/2 z-50">
                <div className="w-full flex items-center justify-between font-bold text-slate-800 border-b border-slate-300 pb-4">
                    ...
                    <button type="button" onClick={onClose} className="p-2 rounded-full border border-primary-02">
                ...
                <div>
                    ...
                    <div className="flex items-center justify-center gap-3">
                        <button id="gallery-btn-prev" className="disabled:opacity-50 btn btn--outline !p-2 bg-white">
                            <FaArrowRightLong className="w-5 h-5" />
                        </button>
                        <button id="gallery-btn-next" className="disabled:opacity-50 btn btn--outline !p-2 bg-white">
