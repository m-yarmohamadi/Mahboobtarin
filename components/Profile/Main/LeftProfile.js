										...
										<div
											...
											<div
												...
												<div className=' flex items-center gap-1 truncate'>
													...
													<span className='font-bold text-sm truncate text-textDefault'>{item.type}</span>
												</div>
			...
			<div className='w-full p-2 '>
				<div className='w-full p-4 bg-slate-200 shadow-md dark:shadow-darkMd  rounded-md'>
					<div className='w-full flex justify-between flex-col sm:flex-row items-center gap-2 text-md font-bold'>
						<span className='truncate text-textDefault'>افرادی برای دنبال کردن</span>
							...
							return (
								<div
									...
									<div className='w-full flex flex-col items-center sm:flex-row lg:flex-col xl:flex-row gap-2 justify-between'>
										...
										<div className='w-full flex items-center justify-between gap-2'>
											<div className='flex-1 flex flex-col gap-1 justify-center items-start'>
												...
												<span className='text-slate-500 text-xs'>{item.idCloud}</span>
											</div>
											<button
									...
									<div className='w-full flex flex-col items-center sm:items-start justify-between gap-2 text-xs'>
										<div>
											<span className='w-full text-xs text-slate-800 leading-5 font-medium'>{item.position}</span>
										</div>
									</div>
								</div>
							);
			...
			<div className='p-3'>
				...
				<div className='w-full h- px-2 my-2 bg-slate-200 rounded-md shadow-md dark:shadow-darkMd'>
					...
					<div className=' flex flex-wrap items-center gap-2 text-xs font-medium'>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>متخصص زنان</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>غدد و متابولیسم</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>دیابت</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>پوست</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>زیبایی</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>بازیگری</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>برنامه نویس</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>فیلمنامه</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>هنرور</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>مغز و اعصاب</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>آموزش فوتبال</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>گوش و حلق و بینی</span>
						<span className='px-3 py-1.5 text-slate-800 bg-slate-100 shadow-sm dark:shadow-darkSm rounded-3xl'>نقاشی</span>
					</div>
