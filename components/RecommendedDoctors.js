    ...
    <div className=" md:container px-8 md:px-0">
      <div className="flex justify-between items-center font-semibold">
        <div className="flex justify-center items-center gap-1">
          ...
          <span className="text-textDefault">پزشکان پیشنهادی</span>
        </div>
      ...
      <div className="w-full grid xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 justify-items-center items-center gap-8 pt-4">
        {data.map((item) => (
          <div
            key={item.id}
            className="w-full bg-primary-02  shadow-md dark:shadow-darkMd  rounded-md py-4 flex flex-col justify-center items-center "
          >
