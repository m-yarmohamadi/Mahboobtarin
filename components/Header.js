							...
							<div className='py-6'>
								<a
									...
									<div className=' w-full  flex justify-center items-center gap-x-2'>
										<div className='w-full bg-primary-01 text-white shadow-md   hover:opacity-80 cursor-pointer font-extrabold   border border-white p-2 rounded-md  flex items-center justify-center '>ورود متخصصان</div>
										<div className='w-full bg-primary-01 text-white shadow-md   hover:opacity-80 cursor-pointer font-extrabold   border border-white p-2 rounded-md  flex items-center justify-center '>ورود کاربران</div>
									</div>
								</a>
							</div>
						</div>
