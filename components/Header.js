            ...
            <header className=" md:mx-auto md:container">
                ...
                >
                    ...
                    <div className="hidden md:flex md:flex-1 md:justify-end  w-full">
                        <div className='py-2 rounded-ss-3xl bg-primary-01 text-white font-bold px-3 hover:opacity-95 cursor-pointer' onClick={() => router.push(`/users/login`)}>ورود</div>
                        <div className='py-2 rounded-ee-3xl bg-primary-01 text-white font-bold px-3 hover:opacity-95 cursor-pointer'>ثبت نام</div>
                        ...
                        <div className="   hover:bg-white cursor-pointer font-extrabold  shadow-lg border border-white p-2 rounded-md text-black flex  justify-center items-center ">
                            ثبت نام کاربران
                        </div>
                        <div
