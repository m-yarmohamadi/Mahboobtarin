        ...
        <div className='grid lg:grid-cols-12 lg:gap-14 grid-cols-1'>
          ...
          <div className='lg:col-span-5 flex flex-col justify-center items-center gap-y-8 w-full '>
            <div className='w-full flex flex-col justify-center items-center'>
              <div className='w-full flex justify-center items-center  p-2 font-bold'>دریافت محبوب‌ترین</div>
            ...
            <div className='w-full flex justify-between justify-items-center items-center gap-x-2'>
              <Link
                className='w-24 p-3 '
              ...
              <div className='w-24 p-3 '>
                <Link
                  ...
                  referrerpolicy='origin'
                  target='_blank'
                  href='https://logo.samandehi.ir/Verify.aspx?id=377286&p=xlaojyoejyoeuiwkmcsigvka'>
                  <img
                    src='/images/samandehi.png'
                    alt='logo-samandehi'
                    id='rgvjjzpejzpenbqeoeukfukz'
                    className=' w-full hover:grayscale'
                  />
                </Link>
