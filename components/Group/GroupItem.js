...
import { FaAngleLeft, FaBattleNet, FaRegHeart, FaShareAlt, FaStar, FaStethoscope } from 'react-icons/fa';
import { FaLocationDot, FaPhoneFlip } from 'react-icons/fa6';
import { MdCastForEducation, MdInsertInvitation, MdOutlineTextsms, MdWifiProtectedSetup } from 'react-icons/md';

const GroupItem = () => {
    return (
        <div className='bg-white shadow-lg border border-primary-02 rounded-md w-full  '>
                    ...
                    <div className='flex justify-center items-center gap-1 h-12'>
                        ...
                        <div className='text-xs bg-primary-05 px-1 py-2 flex flex-col justify-center items-center rounded-md w-20  h-full '>
                            <div className='flex justify-center items-center gap-1 text-primary-01'>
                                <span className='flex justify-center items-center'>11.500+</span>
                                <span className='flex justify-center items-center'><FaStethoscope /></span>
                            </div>
                            
                            <span className='w-full flex justify-center items-center'>مشاوره موفق</span>
                            
                        </div>
                        <div className='text-xs bg-primary-05 px-1 py-2 flex flex-col justify-center items-center rounded-md w-20  h-full '>
                            <div className='flex justify-center items-center gap-1 text-primary-01'>
                                <span className='flex justify-center items-center'>{4.9}</span>
                                <span className='flex justify-center items-center'><FaStar /></span>
                            </div>
                            
                            <span className='w-full flex justify-center items-center'>از {1996} نظر</span>
            ...
            <div className=' w-full flex justify-between items-center text-xs text-gray-700 p-2'>
                <div className='flex justify-center items-center gap-2'>
                    <div className='w-full flex justify-center items-center gap-1 p-1 bg-gray-200 rounded-md '>
                        <span>
                            <FaPhoneFlip />
                        </span>
                        <span>تلفنی</span>
