    ...
    <div>
      ...
      <div className="container -mt-40 px-10">
        <div className="bg-white w-full h-full rounded-3xl container p-4">
          ...
          <News />
          <div>
            <span className="w-full flex justify-center items-center p-2 font-bold">
              سایر تخصص ها
            </span>
            <div className="w-full bg-primary-03 bg-opacity-15 shadow-lg dark:shadow-darkLg h-full rounded-md">
              <div className="grid grid-cols-4 justify-center items-center gap2 p-3">
                {Specialties.map((item, index) => {
                  return (
                    <div key={index}>
                      <span className="flex justify-between items-center gap-1 bg-primary-02 shadow-md dark:shadow-darkMd text-xs p-2 m-1 rounded-md">
                        <span>{item}</span>
                        <span>
                          <FaAngleLeft />
                        </span>
