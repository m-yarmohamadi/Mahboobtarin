    ...
    <div className="w-full ">
      <div className="w-full grid grid-cols-12">
        ...
        <div className="w-full col-span-9 p-4 flex flex-col justify-center items-center gap-4 border border-primary-01 border-opacity-20 rounded-e-2xl">
          <div className="w-full flex justify-between items-center ">
            ...
            <div className="flex justify-center items-center gap-4">
              <button className=" border border-secondary-01 p-2 rounded-full flex justify-center items-center gap-2 text-secondary-01">
                ...
                <span>فیلترها</span>
                <span className="w-6 h-6 rounded-full bg-secondary-01 text-white flex justify-center items-center">
                  1
                </span>
              </button>
              <button className=" border border-secondary-01 p-2 rounded-full flex justify-center items-center gap-2 text-secondary-01">
          ...
          <button
            type="button"
            className="px-4 py-2 border border-primary-01 rounded-md shadow-md dark:shadow-darkMd hover:bg-primary-05"
          >
            نمایش موارد بیشتر
          </button>
        </div>
