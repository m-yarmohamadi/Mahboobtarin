	...
	return (
		<div className='md:mx-auto md:container p-6 mt-6'>
			<div className='w-full flex flex-col sm:flex-row gap-6 items-center justify-between'>
				<h3 className='text-2xl text-secondary-03 font-medium'>فروش ویژه</h3>
				<div className='flex flex-col sm:flex-row items-center gap-4'>
					<Timer />
					<div className='flex items-center gap-3'>
						<button
							id='special-sell-btn-prev'
							className='disabled:opacity-50 btn btn--outline !p-2 bg-white'>
							<FaArrowRightLong className='w-5 h-5' />
						</button>
						<button
							id='special-sell-btn-next'
							className='disabled:opacity-50 btn btn--outline !p-2 bg-white'>
...
function Timer() {
	return (
		<div className='flex flex-col sm:flex-row items-center gap-2'>
			<div className='text-slate-500 font-medium'>زمان باقی مانده:</div>
			<div className='flex items-center gap-3 bg-slate-800 text-yellow-400 px-3 rounded-md'>
				<div className='border-l border-l-slate-500 py-2 pl-3'>20:12:05</div>
