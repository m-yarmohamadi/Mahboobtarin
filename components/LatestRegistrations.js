              ...
              <SwiperSlide key={item.id} className="!w-auto !inline-block">
                ...
                >
                  <div className="w-full flex justify-center items-center justify-items-center text-center px-5">
                    <div className="my-1 relative flex items-center justify-center rounded-3xl w-20 h-20 overflowhidden ring-2 ring-primary-01 ring-offset-2">
                      <img
                        className={
                          !item?.avatar?.length
                            ? "w-11 h-11 md:w-12 md:h-12 rounded-3xl"
                            : "w-full h-full object-cover object-center  hover:grayscale rounded-3xl"
                        }
                        src={
                          item?.avatar?.length
                            ? item?.avatar[0]?.path
